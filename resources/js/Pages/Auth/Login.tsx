        ...
        <>
            ...
            <div className="min-h-screen bg-[#0a0a0a] antialiased overflow-x-hidden relative">
                ...
                <div className="absolute top-0 left-0 w-full h-full z-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute top-[-200px] left-[-200px] w-[600px] h-[600px] bg-[#c4eb5a]/10 rounded-full blur-[100px] animate-glow"></div>
                    <div className="absolute bottom-[-100px] right-[-100px] w-[400px] h-[400px] bg-[#c4eb5a]/5 rounded-full blur-[80px]"></div>
                </div>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="glass-card rounded-3xl p-8 md:p-10 shadow-2xl">
                            <div className="text-center mb-8">
                                <h1 className="text-3xl font-bold text-white mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>Добро пожаловать!</h1>
                                <p className="text-zinc-400">Войдите в свой аккаунт</p>
                            </div>

                            <OAuthButtons mode="login" error={error} />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link
                                            ...
                                            className="text-sm text-[#c4eb5a] hover:text-[#d4f278] transition-colors"
                                        >
                                            Забыли пароль?
                                        </Link>
                                    </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    <Checkbox
                                        ...
                                        className="border-zinc-600 data-[state=checked]:bg-[#c4eb5a] data-[state=checked]:border-[#c4eb5a] data-[state=checked]:text-black"
                                    />
                                    <Label htmlFor="remember" className="font-normal cursor-pointer text-zinc-400 text-sm">
                                        Запомнить меня
                                    </Label>
                                </div>
                            ...
                            <div className="mt-8 text-center">
                                ...
                                <Link href="/register" className="text-[#c4eb5a] hover:text-[#d4f278] font-medium transition-colors">
                                    Зарегистрироваться
                                </Link>
                            </div>
                        </div>
