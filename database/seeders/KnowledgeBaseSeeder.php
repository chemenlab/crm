...
class KnowledgeBaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $gettingStarted = \DB::table('kb_categories')->insertGetId([
            ...
            'description' => 'Основы работы с mClient',
            'parent_id' => null,
            'icon' => 'rocket',
            'color' => '#3b82f6',
            'order' => 1,
